 ...
 * - Windows Electron: window.webkit.messageHandlers.editorBridge（preload 注入）
 *   或 window.equiNative.postMessage / chrome.webview.postMessage
 * - 原生 → JS: window.EditorAPI.* （由 main 挂载）
 */
